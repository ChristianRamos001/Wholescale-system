...
using Sistema001.Web.Models.Almacen.Categoria;
...
namespace Sistema001.Web.Controllers
{
    ...
    public class CategoriasController : ControllerBase
    {
        ...
        public async Task<IActionResult> Desactivar([FromRoute] int id)
        {
            ...
            var categoria = await _context.Categorias.FirstOrDefaultAsync(c => c.idcategoria == id); // expresion lambda para validar con lo que esta en la web vs la base de datos
